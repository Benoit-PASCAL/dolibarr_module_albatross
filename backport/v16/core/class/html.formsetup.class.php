...
class FormSetup
{
	...
	/** @var \Albatross\models\backport\v16\core\class\FormSetupItem[] */
	public $items = array();
	 ...
	 * generateLineOutput
	 *
	 * @param \Albatross\models\backport\v16\core\class\FormSetupItem $item the setup item
	...
	public function addItemFromParams($confKey, $params)
	{
		...
		$item = new \Albatross\models\backport\v16\core\class\FormSetupItem($confKey);
	 ...
	 * @return \Albatross\models\backport\v16\core\class\FormSetupItem the new setup item created
	 */
	 ...
	 *
	 * @param \Albatross\models\backport\v16\core\class\FormSetupItem $a formSetup item
	 * @param \Albatross\models\backport\v16\core\class\FormSetupItem $b formSetup item
